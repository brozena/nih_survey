\begin{table}[ht]
\centering
\caption{Descriptive statistics for each of the 18 vignette scenarios. 
Participants rated their level of comfort on a scale from 0–10, with 0 representing 
complete lack of comfort and 10 representing complete comfort.}
\resizebox{.85\textwidth}{!}{
\begin{tabular}{rlllrrrrrr}
  \hline
 & \textbf{Actors} & \textbf{Intervention Context} & \textbf{Mood State} & \textbf{Mean} & \textbf{Median} & \textbf{SD} & \textbf{Lower} & \textbf{Upper} & \textbf{Obs} \\ 
  \hline
