...
ggsave('plots/expl_interaction_carepartnerhelp_actors_moodstate.png', width=9, height=6, dpi=600, plot_predictions(m9.1, by=c('actors', 'care_partner_help', 'moodstate')) + 
  labs(x='Actor', y='Rating', color='Asked for Help with\nImpulsive Spending') +
  theme_light(base_family='Lato') +
  scale_x_discrete(labels = label_wrap(30)) +
  facet_wrap(~moodstate, scales='free_x')
...
ggsave('plots/expl_main_actors_context_moodstate.png', width=8, height=4, dpi=600, plot_predictions(m2, by=c("actors", "context", "moodstate")) +
  labs(
...
avg_predictions(m14, by=c('context', 'hospitalization'))

ggsave('plots/expl_main_context_hospitalization_moodstate.png', width=10, height=6 , dpi=600, plot_predictions(m14, by=c('context', 'hospitalization', 'moodstate')) + 
