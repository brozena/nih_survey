...
ggsave('plots/H2.2.png', width=9, height=7, units='in', dpi=600, plot_predictions(m4, by=c('context', 'PAD')) +
  labs(x='Intervention Context', y='Rating', color='Do you have a Psychiatric Advance Directive?') +
  scale_x_discrete(labels = label_wrap(10)) +
  scale_fill_discrete(name='Do you have a Psychiatric Advance Directive?') +
  theme_light(base_family='Lato')
)
```
