...
avg_predictions(m14, newdata=datagrid(hospitalization=c('Yes', 'No'), context=c("48-hour Spending Restriction", "Help with Planning & Budgeting", "Share Spending Details")), by=c('context', 'hospitalization'))
