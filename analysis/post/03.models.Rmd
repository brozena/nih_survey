...
ggsave('plots/H1.1_main_moodstate.png', width=9, height=7, units='in', dpi=600, plot_predictions(m2, by=('moodstate')) +
...
ggsave('plots/H2.1_main_context.png', width=8, height=6, units='in', dpi=600, plot_predictions(m2, by=c('context')) +
...
ggsave('plots/H1.3_interaction_context_moodstate.png', width=8, height=6, units='in', dpi=600, plot_predictions(m3, by=c('context', 'moodstate')) +
...
ggsave('plots/H2.2_interaction_context_PAD.png', width=9, height=7, units='in', dpi=600, plot_predictions(m4, newdata=datagrid(PAD=c('Yes', 'No'), context=c("48-hour Spending Restriction", "Help with Planning & Budgeting", "Share Spending Details")), by=c('context', 'PAD')) +
...
ggsave('plots/H2.3_interaction_context_bankruptcydeclared.png', width=9, height=6, units='in', dpi=600, plot_predictions(m5, newdata=datagrid(bankruptcy_declared=c('Yes', 'No'), context=c("48-hour Spending Restriction", "Help with Planning & Budgeting", "Share Spending Details")), by=c('context', 'bankruptcy_declared')) +
...
# Figure caption:
ggsave('plots/expl_interaction_context_bankruptcyconsidered.png', width=9, height=6, units='in', dpi=600, plot_predictions(m5.1, by=c('context', 'bankruptcy_considered', 'moodstate')) +
...
car::Anova(m9, type=3)
ggsave('plots/expl_main_carepartnerhelp_actors.png', width=8, height=6, dpi=600, plot_predictions(m9, newdata=datagrid(care_partner_help=c('Yes', 'No'), actors=c("Care Partner", "Clinicians", "Banks")), by=c('actors', 'care_partner_help')) + 
...
ggsave('plots/expl_interaction_carepartnerhelp_actors_moodstate.png', width=9, height=6, dpi=600, plot_predictions(m9.1, newdata=datagrid(care_partner_help=c('Yes', 'No'), actors=c("Care Partner", "Clinicians", "Banks"), moodstate=c('Euthymic', 'Symptomatic')), by=c('actors', 'care_partner_help', 'moodstate')) + 
  labs(x='Actor', y='Rating', color='Asked for Help with\nImpulsive Spending') +
  theme_light(base_family='Lato') +
  scale_y_continuous(limits=c(0,7)) +
  scale_x_discrete(labels = label_wrap(30)) +
...
ggsave('plots/expl_main_actors_context_moodstate.png', width=9, height=5, dpi=600, plot_predictions(m2, by=c("actors", "context", "moodstate")) +
  labs(
...
ggsave('plots/expl_main_context_hospitalization_moodstate.png', width=9, height=6 , dpi=600, plot_predictions(m14, newdata=datagrid(moodstate=c('Euthymic', 'Symptomatic'), hospitalization=c('Yes', 'No'), context=c("48-hour Spending Restriction", "Help with Planning & Budgeting", "Share Spending Details")), by=c('context', 'hospitalization', 'moodstate')) + 
