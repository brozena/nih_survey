...
p1 = plot_predictions(m12bfi, condition = 'bfi_agreeableness') + labs(x='Agreeableness', y='Rating')
p2 = plot_predictions(m12bfi, condition = 'bfi_openness') + labs(x='Openness', y='Rating')
p3 = plot_predictions(m12bfi, condition = 'bfi_extraversion') + labs(x='Extraversion', y='Rating')
p4 = plot_predictions(m12bfi, condition = 'bfi_neuroticism') + labs(x='Neuroticism', y="Rating'")
p5 = plot_predictions(m12bfi, condition = 'bfi_conscientiousness') + labs(x='Conscientiousness', y='Rating')
