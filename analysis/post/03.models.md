...
```
    ...
    ## 
    ##   Hypothesis Estimate Std. Error      z Pr(>|z|)    S   2.5 %  97.5 %
    ##  (b1) - Mean  -1.3822      0.289 -4.782   <0.001 16.1 -2.1369 -0.6275
    ##  (b2) - Mean  -1.1958      0.542 -2.205   0.1371  2.9 -2.6116  0.2200
    ##  (b3) - Mean  -0.8159      0.299 -2.733   0.0427  4.5 -1.5955 -0.0363
    ##  (b4) - Mean   0.0804      0.289  0.278   1.0000 -0.0 -0.6743  0.8352
    ##  (b5) - Mean   0.0820      0.542  0.151   1.0000 -0.0 -1.3338  1.4977
    ##  (b6) - Mean   1.9027      0.299  6.372   <0.001 29.2  1.1231  2.6823
    ##  (b7) - Mean  -0.2202      0.289 -0.762   1.0000 -0.0 -0.9749  0.5345
    ##  (b8) - Mean   0.7301      0.542  1.347   0.7125  0.5 -0.6856  2.1459
    ##  (b9) - Mean   0.8188      0.299  2.742   0.0427  4.5  0.0392  1.5985
...
m9 \<- lmer(y ~ actors + context + moodstate + diagnosis_subtype +
...
``` r
m14 <- lmer(y ~ actors + context + moodstate + diagnosis_subtype + bankruptcy_considered + bankruptcy_declared + (1|participant) + (1|item), data=long)
avg_predictions(m14, by=c('diagnosis_subtype', 'bankruptcy_declared'))
```

    ## 
    ##                         diagnosis_subtype bankruptcy_declared Estimate Std. Error     z Pr(>|z|)     S 2.5 % 97.5 %
    ##  Bipolar Disorder Not Otherwise Specified            No           4.05      0.224 18.07   <0.001 239.9 3.607   4.48
    ##  Bipolar Disorder Not Otherwise Specified            Not sure     3.37      0.640  5.26   <0.001  22.7 2.115   4.62
    ##  Bipolar Disorder Not Otherwise Specified            Yes          4.94      0.350 14.12   <0.001 147.9 4.255   5.63
    ##  Cyclothymia                                         No           3.43      0.721  4.76   <0.001  19.0 2.020   4.85
    ##  Cyclothymia                                         Yes          5.70      0.920  6.20   <0.001  30.7 3.899   7.51
    ##  I do not know                                       No           4.01      0.354 11.30   <0.001  95.9 3.310   4.70
    ##  I do not know                                       Not sure     1.70      0.738  2.31   0.0212   5.6 0.255   3.15
    ##  I do not know                                       Yes          4.54      0.441 10.28   <0.001  80.0 3.671   5.40
    ##  Type I                                              No           4.13      0.227 18.21   <0.001 243.7 3.687   4.58
    ##  Type I                                              Not sure     2.43      0.663  3.67   <0.001  12.0 1.135   3.73
    ##  Type I                                              Yes          4.63      0.345 13.42   <0.001 134.1 3.950   5.30
    ##  Type II                                             No           4.29      0.181 23.76   <0.001 412.1 3.936   4.64
    ##  Type II                                             Not sure     3.92      0.640  6.13   <0.001  30.1 2.669   5.18
    ##  Type II                                             Yes          4.24      0.320 13.23   <0.001 130.3 3.610   4.87
    ## 
    ## Type:  response
