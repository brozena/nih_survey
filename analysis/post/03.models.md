...
```
    ...
    ## 
    ##   Hypothesis Estimate Std. Error      z Pr(>|z|)    S   2.5 %  97.5 %
    ##  (b1) - Mean  -1.3822      0.289 -4.782   <0.001 16.1 -2.1364 -0.6280
    ##  (b2) - Mean  -1.1958      0.542 -2.205   0.1371  2.9 -2.6106  0.2190
    ##  (b3) - Mean  -0.8159      0.299 -2.733   0.0427  4.5 -1.5950 -0.0368
    ##  (b4) - Mean   0.0804      0.289  0.278   1.0000 -0.0 -0.6738  0.8347
    ##  (b5) - Mean   0.0820      0.542  0.151   1.0000 -0.0 -1.3328  1.4968
    ##  (b6) - Mean   1.9027      0.299  6.372   <0.001 29.2  1.1236  2.6818
    ##  (b7) - Mean  -0.2202      0.289 -0.762   1.0000 -0.0 -0.9744  0.5340
    ##  (b8) - Mean   0.7301      0.542  1.347   0.7125  0.5 -0.6847  2.1449
    ##  (b9) - Mean   0.8188      0.299  2.742   0.0427  4.5  0.0398  1.5979
...
```
    ...
    ## X-squared = 2.861, df = NA, p-value = 0.949
