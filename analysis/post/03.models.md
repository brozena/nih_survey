...
```
    ...
    ##  /var/folders/h2/j2rcc6sn4_vcqzgfkx3nnts40000gn/T//Rtmp9XaW7p/downloaded_packages
...
```
    ...
    ##  (b2) - Mean  -1.1958      0.542 -2.205   0.1371  2.9 -2.6114  0.2198
    ##  (b3) - Mean  -0.8159      0.299 -2.733   0.0427  4.5 -1.5954 -0.0364
    ##  (b4) - Mean   0.0804      0.289  0.278   1.0000 -0.0 -0.6742  0.8351
    ##  (b5) - Mean   0.0820      0.542  0.151   1.0000 -0.0 -1.3336  1.4976
    ##  (b6) - Mean   1.9027      0.299  6.372   <0.001 29.2  1.1231  2.6822
    ##  (b7) - Mean  -0.2202      0.289 -0.762   1.0000 -0.0 -0.9749  0.5345
    ##  (b8) - Mean   0.7301      0.542  1.347   0.7125  0.5 -0.6855  2.1458
    ##  (b9) - Mean   0.8188      0.299  2.742   0.0427  4.5  0.0393  1.5984
...
#long.sample1$actors <- long.sample1 %>% mutate(actors = recode(actors, "clinician" = "Clinicians", "family" = "Family", "you" = "Self"))
long.sample2 <- long
...
```
    ...
    ## |:---------------------:|:------:|:--------:|:---------:|:---------:|:--------:|:-------:|:--------:|:---------:|
    ## |  (clinician) - Mean   |   1    |  -0.48   |   0.036   |    -13    | 1.1e-39  |   129   |  -0.55   |   -0.41   |
    ## |    (family) - Mean    |   1    |    -1    |   0.036   |    -28    | 3.1e-178 |   590   |   -1.1   |   -0.97   |
    ## |     (you) - Mean      |   1    |   1.5    |   0.035   |    43     |    0     |   Inf   |   1.4    |    1.6    |
    ## |    (Banks) - Mean     |   2    |   -1.1   |   0.28    |   -3.9    | 0.00011  |   13    |   -1.6   |   -0.53   |
    ## | (Care Partner) - Mean |   2    |   0.81   |   0.28    |    2.9    |  0.0036  |   8.1   |   0.26   |    1.4    |
    ## |  (Clinicians) - Mean  |   2    |   0.26   |   0.28    |   0.95    |   0.34   |   1.5   |  -0.28   |   0.81    |
...
```
    ...
    ## X-squared = 2.861, df = NA, p-value = 0.9455
