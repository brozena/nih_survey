NIH Finhealth Survey - Preprocessing
================
...
```
    ...
    ## Warning in chisq.test(table(long$ethnicity, long$y), simulate.p.value = T): cannot compute simulated p-value with zero marginals

    ## Warning in chisq.test(table(long$ethnicity, long$y), simulate.p.value = T): Chi-squared approximation may be incorrect

    ## 
    ##  Pearson's Chi-squared test
    ## 
    ## data:  table(long$ethnicity, long$y)
    ## X-squared = NaN, df = 210, p-value = NA
